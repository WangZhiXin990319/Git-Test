  ...
  $.ajax({
    ...
    success: function success(json) {
      $.each(json, function (index, item) {
        var goodsDom = '<li>' + '<div class="u_cover">' + '<img src="' + item.imgurl + '" alt="">' + '<a href="#" title="' + item.title + '" class=msk></a>' + '<div class="bottom">' + '<a href="#" class="f_fr"></a>' + '<span class="erji"></span>' + '<span class="nb">' + item.nb + '</span>' + '</div>' + '</div>' + '<p class="dec">' + '<a href="#" class="tit" title="' + item.title + '">' + item.title + '</a>' + '</p>' + '</li>';
        $('.n_aaa').append(goodsDom);
      });
    }
  });
});